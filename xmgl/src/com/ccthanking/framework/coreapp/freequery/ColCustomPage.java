...
public class ColCustomPage extends BasePageConfig {

	private String strHeader;
	private String strBody;
	private String strTail;
	
	public ColCustomPage() {
	    ...
	    strBuffer.append("}\n");
	    strBuffer.append("</style>\n");
//		strBuffer.append("<script language='javascript' src='/jwzh/jsp/framework/freequery/js/FreeQuery.js'></script>\n");
	    strBuffer.append("</head>\n");
	...
	public void getBody(String p_UserName,String p_Path){
		...
		strBuffer.append("       <input type=\"button\"  value=\"保存\" onclick='doSave()'>&nbsp;\n");
...
//	    		strTemp = objDispVO.getName();
//	    		dispName = "";
//	    		try {
//					if (strTemp != null)
//						dispName = new String(strTemp.getBytes(),"GBK");
