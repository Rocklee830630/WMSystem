...
public class SpellUtil {
	 ...
	 */
	protected static int getCnAscii(char cn) {
	 ...
	 */
	protected static String getSpellByAscii(int ascii) {
	...
	protected static String toSpell(String cnStr) {

		return getFullSpell(cnStr);
	}
	 ...
	 */
	protected static String getFullSpell(String cnStr) {
	...
	protected static String getFirstSpell(String cnStr) {
		return null;
	}
	...
	public static void main(String[] args) {
		String str = null;
		str = "谢海101普降喜雨";
		System.out.println("Spell=" + toSpell(str));
