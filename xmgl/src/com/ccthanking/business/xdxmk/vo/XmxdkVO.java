...
public class XmxdkVO extends BaseVO{

	public XmxdkVO(){
		this.addField("GC_TCJH_XMXDK_ID",OP_STRING|this.TP_PK);
		...
		this.addField("XMWYBH",OP_STRING);
		this.addField("ISJXM",OP_STRING);
		this.addField("XDK_XMBM",OP_STRING);
		this.addField("PRE_XMBM",OP_STRING);
		this.addField("ISNRTJ",OP_STRING);
		this.addField("SFKYBZ",OP_STRING);
	    ...
	    this.bindFieldToDic("ISNATC", "XDZT");
	    this.bindFieldToDic("SFYX", "SF");
	    this.bindFieldToDic("XJXJ", "XMXZ");
	    this.bindFieldToDic("WDD", "WDD");
	    
		//表选
	      this.bindFieldToTranslater("XJ_XMID", "GC_TCJH_XMXDK", "GC_TCJH_XMXDK_ID", "XMMC");
	      this.bindFieldToTranslater("XMGLGS", "FS_ORG_DEPT", "ROW_ID", "BMJC");
	      this.bindFieldToTranslater("YZDB", "FS_ORG_PERSON", "ACCOUNT", "NAME");//业主代表
	      ...
	      this.bindFieldToTranslater("FZR_GLGS", "FS_ORG_PERSON", "ACCOUNT", "NAME");//项目管理公司负责人
	      
	      //金额
	      this.bindFieldToThousand("JHZTZE"); 
	      this.bindFieldToThousand("GC"); 
	      this.bindFieldToThousand("ZC"); 
	      this.bindFieldToThousand("QT"); 
	      this.bindFieldToThousand("ZTZTZE"); 
	      this.bindFieldToThousand("ZTGC"); 
	      this.bindFieldToThousand("ZTZC"); 
	      this.bindFieldToThousand("ZTQT"); 
		this.setVOTableName("GC_TCJH_XMXDK");
	}

	public void setGc_tcjh_xmxdk_id(String gc_tcjh_xmxdk_id){
		this.setInternal("GC_TCJH_XMXDK_ID",gc_tcjh_xmxdk_id);
	}
	public String getGc_tcjh_xmxdk_id(){
		return (String)this.getInternal("GC_TCJH_XMXDK_ID");
	}
	...
	public void setXmwybh(String xmwybh){
		this.setInternal("XMWYBH",xmwybh);
	}
	public String getXmwybh(){
		return (String)this.getInternal("XMWYBH");
	}
	public void setIsjxm(String isjxm){
		this.setInternal("ISJXM",isjxm);
	}
	public String getIsjxm(){
		return (String)this.getInternal("ISJXM");
	}
	public void setXdk_xmbm(String xdk_xmbm){
		this.setInternal("XDK_XMBM",xdk_xmbm);
	}
	public String getXdk_xmbm(){
		return (String)this.getInternal("XDK_XMBM");
	}
	public void setPre_xmbm(String pre_xmbm){
		this.setInternal("PRE_XMBM",pre_xmbm);
	}
	public String getPre_xmbm(){
		return (String)this.getInternal("PRE_XMBM");
	}
	...
	public void Sfkybz(String sfkybz){
		this.setInternal("SFKYBZ",sfkybz);
	}
	public String Sfkybz(){
		return (String)this.getInternal("SFKYBZ");
	}
}