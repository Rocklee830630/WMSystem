...
public class ZtbtjglVO extends BaseVO{

	public ZtbtjglVO(){
		this.addField("GC_ZTB_TJGL_ID",OP_STRING|this.TP_PK);
		this.addField("JHSJID",OP_STRING);
		this.addField("XMID",OP_STRING);
		this.addField("ND",OP_STRING);
		this.addField("ZBTJZT",OP_STRING);
		...
		this.setVOTableName("GC_ZTB_TJGL");
	}

	public void setGc_ztb_tjgl_id(String gc_ztb_tjgl_id){
		this.setInternal("GC_ZTB_TJGL_ID",gc_ztb_tjgl_id);
	}
	public String getGc_ztb_tjgl_id(){
		return (String)this.getInternal("GC_ZTB_TJGL_ID");
	}
	...
	public void setZbtjzt(String zbtjzt){
		this.setInternal("ZBTJZT",zbtjzt);
	}
	public String getZbtjzt(){
		return (String)this.getInternal("ZBTJZT");
	}
