...
public class PqJzVO extends BaseVO{

	public PqJzVO(){
		this.addField("GC_PQ_JZ_ID",OP_STRING|this.TP_PK);
		...
		this.setFieldDateFormat("JZRQ","yyyy-MM-dd");
		this.setFieldDateFormat("LRSJ","yyyy-MM-dd");
		this.setFieldDateFormat("GXSJ","yyyy-MM-dd");
		this.setVOTableName("GC_PQ_JZ");
	}

	public void setGc_pq_jz_id(String gc_pq_jz_id){
		this.setInternal("GC_PQ_JZ_ID",gc_pq_jz_id);
	}
	public String getGc_pq_jz_id(){
		return (String)this.getInternal("GC_PQ_JZ_ID");
	}
	...
	public void setJzrq(Date jzrq){
		this.setInternal("JZRQ",jzrq);
	}
	public Date getJzrq(){
		return (Date)this.getInternal("JZRQ");
	}
