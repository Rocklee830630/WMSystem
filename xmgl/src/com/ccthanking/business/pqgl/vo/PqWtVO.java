...
public class PqWtVO extends BaseVO{

	public PqWtVO(){
		this.addField("GC_PQ_WT_ID",OP_STRING|this.TP_PK);
		...
		this.setVOTableName("GC_PQ_WT");
	}

	public void setGc_pq_wt_id(String gc_pq_wt_id){
		this.setInternal("GC_PQ_WT_ID",gc_pq_wt_id);
	}
	public String getGc_pq_wt_id(){
		return (String)this.getInternal("GC_PQ_WT_ID");
	}
