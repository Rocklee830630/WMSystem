...
public class GcXmflglbVO extends BaseVO{
	...
	public GcXmflglbVO(){
		...
		this.setVOTableName("gc_xmflglb");
	}
	...
	public void setOrderno(String orderno){
		this.setInternal("ORDERNO",orderno);
	}
	public String getOrderno(){
		return (String)this.getInternal("ORDERNO");
	}
	public void setLy(String ly){
		this.setInternal("LY",ly);
	}
	public String getLy(){
		return (String)this.getInternal("LY");
	}
