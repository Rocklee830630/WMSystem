...
import com.ccthanking.business.qqsx.ghsp.sxfj.GhspSxfjService;
 ...
 */
@Controller
@RequestMapping("/qqsx/ghsp/sxfjController")
public class GhspSxfjController {

	
	@Autowired
	private GhspSxfjService sxfjService;
	/**
	 * 结算list
	 * @param json
	 * @return
