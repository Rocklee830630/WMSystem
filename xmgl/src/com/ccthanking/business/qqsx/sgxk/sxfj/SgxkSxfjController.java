...
import com.ccthanking.business.qqsx.sgxk.sxfj.SgxkSxfjService;
 ...
 */
@Controller
@RequestMapping("/qqsx/sgxk/sxfjController")
public class SgxkSxfjController {

	
	@Autowired
	private SgxkSxfjService sxfjService;
	/**
	 * 结算list
	 * @param json
	 * @return
	...
	@ResponseBody
	public requestJson queryConditionSxfj(HttpServletRequest request,requestJson json) throws Exception
	{
		requestJson j = new requestJson();
	...
	public requestJson querySxfjzj(HttpServletRequest request,requestJson json) throws Exception
	{
		...
		String  domresult = "";
		String jhsjid=request.getParameter("jhsjid");
		domresult = this.sxfjService.querySxfjzj(request,json.getMsg(),jhsjid);
		j.setMsg(domresult);
		return j;
	}
	//添加
