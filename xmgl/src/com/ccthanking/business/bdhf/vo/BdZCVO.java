...
public class BdZCVO extends BaseVO{

	public BdZCVO(){
		this.addField("GC_XMBD_ZC_ID",OP_STRING|this.TP_PK);
		this.addField("GC_XMBD_ID",OP_STRING);
	    ...
	    this.setVOTableName("GC_XMBD_ZC");
	...
	public void setGc_xmbd_zc_id(String gc_xmbd_zc_id){
		this.setInternal("GC_XMBD_ZC_ID",gc_xmbd_zc_id);
	}
	public String getGc_xmbd_zc_id(){
		return (String)this.getInternal("GC_XMBD_ZC_ID");
	}
	...
	public void setIsgx(String isgx){
		this.setInternal("ISGX",isgx);
	}
	public String getIsgx(){
		return (String)this.getInternal("ISGX");
	}	
