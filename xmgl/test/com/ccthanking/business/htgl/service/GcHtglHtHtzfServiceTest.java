/* ==================================================================
 * 版权：    kcit 版权所有 (c) 2013
 * 文件：    htgl.service.GcHtglHtHtzfServiceTest.java
 * 创建日期： 2013-09-03 上午 09:38:07
 * 功能：    测试类：合同数据
 * 所含类:   GcHtglHtHtzfService.java
 * 修改记录：
 ...
 * 
 * <p>
 * <a href="GcHtglHtHtzfManagerTest.java.html"><i>查看源代码</i></a>
 * </p>
 * 
...
public class GcHtglHtHtzfServiceTest extends ServiceTest {

    private static Logger logger = LoggerFactory.getLogger(GcHtglHtHtzfServiceTest.class);

    @Autowired
    @Qualifier("gcHtglHtHtzfServiceImpl")
    private GcHtglHtHtzfService service;
    ...
    public void testFindbyPk() {
        ...
        GcHtglHtHtzfVO tmp = service.findById("11");
        logger.info("{}", tmp);
    ...
    public void testCRUD() {
        ...
        GcHtglHtHtzfVO tmp = new GcHtglHtHtzfVO();
        tmp.setId(id);
        
        tmp.setHtsjid("63eb5e51-fca3-4686-8382-24bf6dec89b1");
        
        
        tmp.setZfnf("2013");
        tmp.setZfyf(String.valueOf(RandomUtils.nextInt(10)));
        
        tmp.setInternal("ZFRQ", DateTimeUtil.getDate());
        tmp.setZfje(String.valueOf(RandomUtils.nextInt()));
        tmp.setYfk(String.valueOf(RandomUtils.nextInt()));
        tmp.setBcwcgzl(String.valueOf(RandomUtils.nextInt(100)));
        ...
        List<GcHtglHtHtzfVO> list = new ArrayList<GcHtglHtHtzfVO>();
        list.add(tmp);
        ...
        try {
            ...
            // GcHtglHtHtzfVO inVO = new GcHtglHtHtzfVO();
