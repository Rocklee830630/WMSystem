		...
		<div class="B-small-from-table-autoConcise">
			...
			<form method="post" id="queryForm">
				<table class="B-table" width="100%">
					...
					<tr>
						<th width="5%" class="right-border bottom-border">责任部门</th>
						<td class="right-border bottom-border"  colspan=7>
							<input class="span12" id="ZRBM" type="checkbox" kind="dic" src="ZRBM"  name="ZRBM" fieldname="ZRBM" operation="in" fieldtype="text">
						</td>					
					</tr>
				</table>
			</form>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single" pageNum="5" printFileName="项目储备库">
	                <thead>		                		
	                    <tr>
							...
							<th fieldname="ISXD" rowspan="2" colindex=4 tdalign="center">&nbsp;是否下达&nbsp;</th>
							<!-- 
							<th fieldname="PCH" rowspan="2" tdalign="center" colindex=5>&nbsp;批次号&nbsp;</th>
							 -->
							<th fieldname="XMLX" rowspan="2" colindex=5 tdalign="center">&nbsp;项目类型&nbsp;</th>
							<th fieldname="ISBT" rowspan="2" colindex=6 tdalign="center">&nbsp;BT&nbsp;</th>
							<th fieldname="XMDZ" rowspan="2" colindex=7 maxlength="15">&nbsp;项目地址&nbsp;</th>
							<th colspan="4">&nbsp;年度总投资额（万元）&nbsp;</th>
							<th fieldname="QY" rowspan="2" colindex=12 maxlength="15">&nbsp;所属城区&nbsp;</th>
	                    </tr>
	                    <tr>
							<th fieldname="GC" colindex=8 tdalign="right">&nbsp;工程&nbsp;</th>
							<th fieldname="ZC" colindex=9 tdalign="right">&nbsp;征拆&nbsp;</th>
							<th fieldname="QT" colindex=10 tdalign="right">&nbsp;其他&nbsp;</th>
							<th fieldname="JHZTZE" colindex=11 tdalign="right">&nbsp;合计&nbsp;</th>
	                	</tr>
	                </thead> 
	              	<tbody></tbody>
	           </table>
