...
function queryList(){
	...
	//调用ajax插入
	defaultJson.doQueryJsonList(controllername+"?queryXmxx&ywlx="+ywlx+"&bmjkLx="+bmjkLx+"&nd="+nd+"&tableName="+tableName+"&xmglgs="+xmglgs,data,DT1);
}
//项目名称自动模糊查询参数
						...
						<table class="table-hover table-activeTd B-table" id="DT1"
							...
							<thead>
								<tr>
									...
									<th fieldname="XMMC" rowspan="2" colindex=3 maxlength="15"
										rowMerge="true">
										&nbsp;项目名称&nbsp;
									</th>
									...
									<th fieldname="BDBH" rowspan="2" colindex=8
										CustomFunction="doBdbh">
										&nbsp;标段编号&nbsp;
									</th>
									<th fieldname="BDMC" rowspan="2" colindex=9 maxlength="15"
										CustomFunction="doBdmc">
										&nbsp;标段名称&nbsp;
									</th>
									<th fieldname="XMXZ" rowspan="2" colindex=10 tdalign="center">
										&nbsp;项目性质&nbsp;
									</th>
									<th fieldname="JSMB" rowspan="2" colindex=11 maxlength="15">
										&nbsp;年度目标&nbsp;
									</th>
									<th colspan="2">
										&nbsp;工期安排（工程部及项目管理公司）&nbsp;
									...
									<th fieldname="ZC" rowspan="2" colindex=26 tdalign="center"
										CustomFunction="doZC">
										&nbsp;征拆&nbsp;
									</th>
									<th fieldname="PQ" rowspan="2" colindex=27 tdalign="center"
										CustomFunction="doPQ">
										&nbsp;排迁&nbsp;
									</th>
									<th fieldname="JG" rowspan="2" colindex=28 tdalign="center"
										CustomFunction="doJG">
										&nbsp;交工&nbsp;
									</th>
									<th fieldname="BZ" rowspan="2" colindex=29 maxlength="10">
										&nbsp;备注&nbsp;
									</th>
								</tr>
								<tr>
									<th fieldname="KGSJ" colindex=12 tdalign="center"
										CustomFunction="doKGSJ">
										&nbsp;开工时间&nbsp;
									</th>
									<th fieldname="WGSJ" colindex=13 tdalign="center"
										CustomFunction="doWGSJ">
										&nbsp;完工时间&nbsp;
									</th>
									<th fieldname="KYPF" colindex=14 tdalign="center"
										CustomFunction="doKYPF">
										&nbsp;可研批复&nbsp;
									</th>
									<th fieldname="HPJDS" colindex=15 tdalign="center"
										CustomFunction="doHPJDS">
										&nbsp;划拔决定书&nbsp;
									</th>
									<th fieldname="GCXKZ" colindex=16 tdalign="center"
										CustomFunction="doGCXKZ">
										&nbsp;工程规划许可证&nbsp;
									</th>
									<th fieldname="SGXK" colindex=17 tdalign="center"
										CustomFunction="doSGXK">
										&nbsp;施工许可&nbsp;
									</th>
									<th fieldname="CBSJPF" colindex=18 tdalign="center"
										CustomFunction="doCBSJPF">
										&nbsp;初步设计批复&nbsp;
									</th>
									<th fieldname="CQT" colindex=19 tdalign="center"
										CustomFunction="doCQT">
										&nbsp;拆迁图&nbsp;
									</th>
									<th fieldname="PQT" colindex=20 tdalign="center"
										CustomFunction="doPQT">
										&nbsp;排迁图&nbsp;
									</th>
									<th fieldname="SGT" colindex=21 tdalign="center"
										CustomFunction="doSGT">
										&nbsp;施工图&nbsp;
									</th>
									<th fieldname="TBJ" colindex=22 tdalign="center"
										CustomFunction="doTBJ">
										&nbsp;提报价&nbsp;
									</th>
									<th fieldname="CS" colindex=23 tdalign="center"
										CustomFunction="doCS">
										&nbsp;财审&nbsp;
									</th>
									<th fieldname="JLDW" colindex=24 tdalign="center"
										CustomFunction="doJLDW">
										&nbsp;监理单位&nbsp;
									</th>
									<th fieldname="SGDW" colindex=25 tdalign="center"
