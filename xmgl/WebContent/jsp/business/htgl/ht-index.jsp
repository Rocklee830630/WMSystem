...
function setPageHeight(){
	var height = g_iHeight-pageTopHeight-pageTitle-pageQuery-getTableTh(5)-pageNumHeight;
...
<%--	});--%>
	$("#btnInsert").click(function() {
		...
		$(window).manhuaDialog({"title":"合同>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/ht-add-bm.jsp?type=update&dkfs=htxx","modal":"1"});
	});
	//按钮绑定事件(修改)
				...
				<div class="B-small-from-table-autoConcise">
					<h4 class="title">
						...
						<span class="pull-right">
							<app:oPerm url="jsp/business/htgl/hthtzf-indexOne.jsp?type=update">
									<button id="btnInsert" class="btn" type="button" style="font-family:SimYou,Microsoft YaHei;font-weight:bold;">合同信息</button>
							</app:oPerm> 
							<app:oPerm url="jsp/business/htgl/hthtzf-indexOne.jsp?type=zfxx">
									<button id="btnUpdate" class="btn" type="button" style="font-family: SimYou, Microsoft YaHei; font-weight: bold;">支付信息</button>
							</app:oPerm> 
							<app:oPerm url="jsp/business/htgl/hthtzf-indexOne.jsp?type=tzwc"> 
...
<%--									title="条件：只有审核中的合同才可以进行此操作"--%>
							...
							<app:oPerm url="jsp/business/htgl/ht-view-htzz.jsp?type=update&opttype=htjs">
							<button id="btnHtjs" class="btn" type="button" style="font-family: SimYou, Microsoft YaHei; font-weight: bold;">合同结束</button>
							</app:oPerm>
							<app:oPerm url="jsp/business/htgl/ht-view-htzz.jsp?type=update&opttype=htzz">
							<button id="btnHtzz" class="btn" type="button" style="font-family: SimYou, Microsoft YaHei; font-weight: bold;">合同中止</button>
							</app:oPerm>
					...
					<form method="post" id="queryForm">
						<table class="B-table" width="100%">
							...
							<TR style="display: none;">
								...
								<TD class="right-border bottom-border">
									...
									<INPUT type="text" class="span12" kind="text" id="ZBBM"
										...
										fieldname="to_number(HTZT)" operation=">=" value="-2">
												<%
											}
										%>
							...
							<tr>
								...
								<td class="text-left bottom-border text-right" rowspan=4>
							...
							<tr>
								...
								<td class="right-border bottom-border">
									<select id="HTZT" class="span12 3characters" name="HTZT"
										fieldname="HTZT" operation="=" kind="dic"  src="T#FS_DIC_TREE:DIC_CODE:DIC_VALUE: PARENT_ID='9000000000141'  AND  DIC_CODE!='-3' ORDER BY  DIC_CODE  "
										defaultMemo="全部">
								</td>
								<th width="5%" class="right-border bottom-border text-right">
									合同类型
								...
								<td width="17%" class="right-border bottom-border">
									<select id="HTLX" class="span12" name="HTLX" fieldname="HTLX"
										operation="=" kind="dic" src="HTLX" defaultMemo="全部">
								</td>
								<th width="5%" class="right-border bottom-border text-right">
									主办部门
								</th>
							...
							<!-- 添加乙方单位的查询条件 add by xiahongbo on 2015-01-20 start -->
							<tr>
								<th width="5%" class="right-border bottom-border text-right">
									乙方单位
								</th>
								<td class="right-border bottom-border" colspan="3">
									<input id="HTMC" class="span12" type="text" autocomplete="off"
										placeholder="" name="YFDW" check-type="maxlength"
										maxlength="1000" fieldname="YFDW" operation="like" logic="and" />
								</td>
								<td class="right-border bottom-border" colspan="4"></td>
							</tr>
							<!-- 添加乙方单位的查询条件 add by xiahongbo on 2015-01-20 end -->
							<tr id="cwzj_tj">
								<th width="5%" class="right-border bottom-border text-right">
									审批情况
								</th>
						...
						<table width="100%" class="table-hover table-activeTd B-table"
							...
							<thead>
								<tr>
									...
									<th rowspan="2" fieldname="YFDW" colindex=7 tdalign="left"
									...
									<th rowspan="2" fieldname="ZWCZF" colindex=11 tdalign="right"
										CustomFunction="doRandering_ZWCZF">
										&nbsp;完成投资&nbsp;
									</th>
									<th rowspan="2" fieldname="ZHTZF" colindex=12 tdalign="right"
										CustomFunction="doRandering_ZHTZF">
										&nbsp;合同支付&nbsp;
									</th>
									<th rowspan="2" fieldname="SFXNHT" colindex=13 tdalign="center">
										&nbsp;是否虚拟&nbsp;
									</th>
									<th rowspan="2" fieldname="SFDXMHT" colindex=14 tdalign="center" CustomFunction="doSFDXM">
										&nbsp;单项目&nbsp;
									</th>
									<th rowspan="2" fieldname="SFZFJTZ" colindex=15 tdalign="center">
										&nbsp;支付即投资&nbsp;
									</th>
									<th rowspan="2" fieldname="ZBBM" colindex=16 tdalign="left"
								...
								<tr>
									<th fieldname="ZHTQDJ" colindex=8 tdalign="right">
										&nbsp;合同签订价&nbsp;
									</th>
									<th fieldname="ZBGJE" colindex=9 tdalign="right"
										CustomFunction="doRandering_ZBGJE">
										&nbsp;变更金额&nbsp;
									</th>
									<th fieldname="ZZXHTJDO" colindex=10 tdalign="right">
										&nbsp;最新合同价&nbsp;
									</th>
								</tr>
							</thead>
