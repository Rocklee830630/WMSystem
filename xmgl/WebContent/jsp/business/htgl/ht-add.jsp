 ...
 */
function xzZtb() {
	$(window).manhuaDialog({"title" : "","type" : "text","content" : "${pageContext.request.contextPath}/jsp/business/ztb/ztbQuery.jsp","modal":"4"});
}
/*
 * 获取招投标返回数据方法
 */
function selectZtb(data) {
		/* alert(data); */
	}
</script>      
</head>
      ...
      <table class="B-table" width="100%" >
		...
		<tr>
			...
			<td width="17%" class="right-border bottom-border">
				...
				<button class="btn btn-link"  type="button" onclick="xzZtb();"><abbr title="点击选择招投标"><i class="icon-edit"></i></abbr></button>
			</td>
