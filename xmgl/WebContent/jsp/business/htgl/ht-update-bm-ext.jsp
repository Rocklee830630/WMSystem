...
<%--		}--%>
		...
		queryFileData(tempJson.ID,"","","");
		 ...
		 if (typeof(tempJson) != "undefined"){
				...
				defaultJson.doQueryJsonList(controllernameHtsj+"?queryOne",data,DT2);
		}
	 <%
		}
	%>
...
<%--		  <button id="example1" class="btn"  type="button">选择项目</button>--%>
	   ...
	   <form method="post"  id="demoForm1"  >
     	<div class= "overFlowX" >
				<table class="table-hover table-activeTd B-table" id="DT2" width="100%" type="single" editable="0">
					<thead>
						<tr>
      ...
      <table class="B-table" width="100%" >
		...
		<tr>
			...
			<td width="17%" class="right-border bottom-border">
				...
				<button class="btn btn-link"  type="button" onclick="queryProjectWithBD()" disabled><abbr title="点击选择招投标"><i class="icon-edit"></i></abbr></button>
			</td>
...
<%--					<input class="span12" id="BXQDWLX" type="radio" placeholder="" kind="dic" src="BXQDW" name = "BXQDWLX" fieldname="BXQDWLX">--%>
		...
		<tr>
			...
			<td width="17%" class="right-border bottom-border">
				<input id="JFDW"   placeholder="必填" check-type="required" class="span12" check-type="maxlength" maxlength="1000"  name="JFDW" fieldname="JFDW" type="text" style="width:88%" disabled/>
				<button class="btn btn-link"  type="button" id="deptBtn_JFDW" value="JFDW"><abbr title="点击选择甲方单位"><i class="icon-edit"></i></abbr></button>
			</td>
