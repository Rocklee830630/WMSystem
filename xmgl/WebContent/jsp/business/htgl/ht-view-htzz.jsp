	...
	$("#btnHTZZ").click(function() {
		...
		if($("#gcHtglHtForm").validationButton())
		{
			...
			$('#ConfirmYesButton').one("click",function(){
				...
				defaultJson.doUpdateJson(controllername + "?update&opttype=htzz&id="+$("#ID").val(), data1);
			});
		}
	});
});
				...
				<div class="B-small-from-table-autoConcise">
					<h4 class="title">
						...
						<span class="pull-right">
							<button id="btnHTZZ" class="btn" type="button"
								style="font-family: SimYou, Microsoft YaHei; font-weight: bold;">
								中止合同
							</button>
					...
					<form method="post" id="gcHtglHtForm">
						...
						<table class="B-table" width="100%">
							<tr>
								...
								<td width="17%" class="right-border bottom-border">
									<input id="JFDW" class="span12" check-type="maxlength"
										maxlength="1000" name="JFDW" fieldname="JFDW" type="text"
								...
								<td width="17%" class="right-border bottom-border">
									<input id="JFQDR" class="span12" name="JFQDR" fieldname="JFQDR" type="text"
										style="width: 88%" disabled />
								</td>
							</tr>
							<tr>
								...
								<td width="17%" class="right-border bottom-border">
									<input id="ZBBM" class="span12" check-type="maxlength"
										maxlength="36" name="ZBBM" fieldname="ZBBM" type="text"
										style="width: 88%" disabled />
								</td>
								<th width="8%"
									class="right-border bottom-border text-right disabledTh">
		 ...
		 %>
						...
						<table class="B-table" width="100%">
							...
							<tr>
								...
								<td colspan="3" class="bottom-border right-border">
									<textarea class="span12" rows="2" id="HTZZLY"
										check-type="maxlength" maxlength="4000" fieldname="HTZZLY"
										name="HTZZLY"></textarea>
								</td>
							</tr>
							<tr>
								<th width="8%"
