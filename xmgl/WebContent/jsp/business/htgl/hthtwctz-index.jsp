...
$(function() {
	...
	$("#btnInsert").click(function() {
		parent.$("body").manhuaDialog({"title":"合同完成投资>新增","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtwctz-add.jsp?type=insert","modal":"1"});
	});
	//按钮绑定事件(修改)
	$("#btnUpdate").click(function() {
		...
		parent.$("body").manhuaDialog({"title":"合同完成投资>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtwctz-add.jsp?type=update","modal":"1"});
	});
	//按钮绑定事件（导出EXCEL）
...
function rowView(index){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	parent.$("body").manhuaDialog({"title":"合同完成投资>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtwctz-add.jsp?type=detail","modal":"1"});
}
</script>
</head>
<body>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="NF" colindex=2 tdalign="center" maxlength="4">&nbsp;年份&nbsp;</th>
							<th fieldname="YF" colindex=3 tdalign="center" maxlength="2">&nbsp;月份&nbsp;</th>
							<th fieldname="WCTZJE" colindex=4 tdalign="center" maxlength="17">&nbsp;完成投资金额&nbsp;</th>
							<th fieldname="WCTZLX" colindex=5 tdalign="center" maxlength="40">&nbsp;完成投资类型&nbsp;</th>
							<th fieldname="BZ" colindex=10 tdalign="center" maxlength="35">&nbsp;备注&nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>
