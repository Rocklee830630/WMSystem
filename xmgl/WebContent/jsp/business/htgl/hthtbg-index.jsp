...
$(function() {
	...
	$("#btnInsert").click(function() {
		parent.$("body").manhuaDialog({"title":"合同变更>新增","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtbg-add.jsp?type=insert","modal":"1"});
	});
	//按钮绑定事件(修改)
	$("#btnUpdate").click(function() {
		...
		parent.$("body").manhuaDialog({"title":"合同变更>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtbg-add.jsp?type=update","modal":"1"});
	});
	//按钮绑定事件（导出EXCEL）
...
function rowView(index){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	parent.$("body").manhuaDialog({"title":"合同变更>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/htgl/hthtbg-add.jsp?type=detail","modal":"1"});
}
</script>
</head>
<body>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="BGJE" colindex=4 tdalign="center" maxlength="17">&nbsp;变更金额&nbsp;</th>
