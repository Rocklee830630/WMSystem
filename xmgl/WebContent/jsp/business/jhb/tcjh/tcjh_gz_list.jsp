...
function queryList(){
	...
	//调用ajax插入
	defaultJson.doQueryJsonList(controllername+"?queryXfjh",data,tcjhList,"queryAfter",false);
}
...
function generateFyjjhNdMc(ndObj,mcObj){
	...
	if(mcObj){
		mcObj.attr("kind","dic");
		mcObj.attr("src","T#GC_JH_ZT:GC_JH_ZT_ID:jhpch:SFYX='1' AND (ISXF='1' or GC_JH_ZT_ID in (select JHID from GC_JH_SJ where SFYX='1' and GC_JH_SJ_ID in (select JHSJID from GC_JH_ZT_XM where SFYX='1'))) AND ND='" + ndObj.val()+"' and GC_JH_ZT_ID in(select JHID from GC_JH_SJ where sfyx='1' and nd='"+ ndObj.val()+"' and XMSX='1') ORDER BY JHPCH ASC");
		mcObj.html('');
...
<p></p>
      ...
      <!--可以再此处加入hidden域作为过滤条件 -->
      	<TR  style="display:none;">
			...
			<TD class="right-border bottom-border">
				<INPUT type="text" class="span12" kind="text" id="ISXF" fieldname="t.ISXF" keep="true" value="1" operation="=" >
				<input type="text" class="span12" kind="text" fieldname="t.XMSX" name="qXMSX" value="1" keep="true" operation="="> 
			</TD>
        </TR>
        <!--可以再此处加入hidden域作为过滤条件 -->
        <tr>
 ...
 <div class="overFlowX">
	<table class="table-hover table-activeTd B-table" id="tcjhList" width="100%" type="single" pageNum="1000" noPage="true" printFileName="统筹计划跟踪">
		<thead>
			<tr>
				...
				<th fieldname="XMBH" rowspan="2" colindex=4 hasLink="true" maxlength="15" linkFunction="rowView" rowMerge="true">&nbsp;项目编号&nbsp;</th>
				<th fieldname="XMMC" rowspan="2" colindex=5 maxlength="10" rowMerge="true">&nbsp;项目名称&nbsp;</th>
				<th fieldname="BDBH" rowspan="2" colindex=6 maxlength="15" CustomFunction="doBdbh">&nbsp;标段编号&nbsp;</th>
				<th fieldname="BDMC" rowspan="2" colindex=7 maxlength="10" CustomFunction="doBdmc" >&nbsp;标段名称&nbsp;</th>
				<th fieldname="XMDZ" rowspan="2" colindex=8 maxlength="10">&nbsp;建设位置&nbsp;</th>
				<th fieldname="XMDZ" rowspan="2" colindex=9 CustomFunction="doDz" noprint="true">&nbsp;&nbsp;</th>
				<th fieldname="XMGLGS" rowspan="2" colindex=10 maxlength="15" tdalign="center">&nbsp;项目管理公司&nbsp;</th>
				<th fieldname="JSNR" rowspan="2" colindex=11  maxlength="15">&nbsp;建设内容及规模&nbsp;</th>
				<th fieldname="XMXZ" rowspan="2" colindex=12 tdalign="center">&nbsp;项目性质&nbsp;</th>
				<th fieldname="JSMB" rowspan="2" maxlength="15" colindex=13 >&nbsp;年度目标&nbsp;</th>
				<th colspan="2">&nbsp;工期安排（工程部及项目管理公司）&nbsp;</th>
				<th colspan="4">&nbsp;手续办理情况&nbsp;</th>
				<th colspan="4">&nbsp;设计情况&nbsp;</th>
				<th colspan="2">&nbsp;造价&nbsp;</th>
				<th colspan="2">&nbsp;招标&nbsp;</th>
				<th fieldname="ZC_SJ" rowspan="2" colindex=28 tdalign="center" CustomFunction="doZC">&nbsp;征拆&nbsp;</th>
				<th fieldname="PQ_SJ" rowspan="2" colindex=29 tdalign="center" CustomFunction="doPQ">&nbsp;排迁&nbsp;</th>
				<th fieldname="JG_SJ" rowspan="2" colindex=30 tdalign="center" CustomFunction="doJG">&nbsp;交工&nbsp;</th>
			</tr>
			<tr>
				<th fieldname="KGSJ_SJ" colindex=14 tdalign="center" CustomFunction="doKG">&nbsp;开工时间&nbsp;</th>
				<th fieldname="WGSJ_SJ" colindex=15 tdalign="center" CustomFunction="doWG">&nbsp;完工时间&nbsp;</th>
				<th fieldname="KYPF_SJ" colindex=16 tdalign="center" CustomFunction="doKYPF">&nbsp;可研批复&nbsp;</th>
				<th fieldname="HPJDS_SJ" colindex=17 tdalign="center" CustomFunction="doHBJDS">&nbsp;划拔决定书&nbsp;</th>
				<th fieldname="GCXKZ_SJ" colindex=18 tdalign="center" CustomFunction="doGCGHXKZ">&nbsp;工程规划许可证&nbsp;</th>
				<th fieldname="SGXK_SJ" colindex=19 tdalign="center" CustomFunction="doSGXK">&nbsp;施工许可&nbsp;</th>
				<th fieldname="CBSJPF_SJ" colindex=20 tdalign="center" CustomFunction="doCBSJPF">&nbsp;初步设计批复&nbsp;</th>
				<th fieldname="CQT_SJ" colindex=21 tdalign="center" CustomFunction="doCQT">&nbsp;拆迁图&nbsp;</th>
				<th fieldname="PQT_SJ" colindex=22 tdalign="center" CustomFunction="doPQT">&nbsp;排迁图&nbsp;</th>
				<th fieldname="SGT_SJ" colindex=23 tdalign="center" CustomFunction="doSGT">&nbsp;施工图&nbsp;</th>
				<th fieldname="TBJ_SJ" colindex=24 tdalign="center" CustomFunction="doTBJ">&nbsp;提报价&nbsp;</th>
				<th fieldname="CS_SJ" colindex=25 tdalign="center" CustomFunction="doCS">&nbsp;财审&nbsp;</th>
				<th fieldname="JLDW_SJ" colindex=26 tdalign="center" CustomFunction="doJLDW">&nbsp;监理单位&nbsp;</th>
				<th fieldname="SGDW_SJ" colindex=27 tdalign="center" CustomFunction="doSGDW">&nbsp;施工单位&nbsp;</th>
