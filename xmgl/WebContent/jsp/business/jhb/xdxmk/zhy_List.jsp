...
function queryAfter(){
 	var height = g_iHeight-pageTitle-pageQuery-getTableTh(3);
	var pageNum = parseInt(height/pageTableOne,10);
  ...
  <div class="row-fluid">
     <div class="B-small-from-table-autoConcise">
      <h4 class="title">项目下达库
      	...
      	<app:oPerm url="jsp/business/jhb/xdxmk/xmwh.jsp">
      		<button id="btnXmwh" class="btn" type="button">维护</button>
      	</app:oPerm>
      	<app:oPerm url="jsp/business/jhb/xdxmk/aPcxdtc.jsp">
	  		<button id="btnXdtc" class="btn"  type="button">下达项目</button>
	  	</app:oPerm>
        ...
        <tr>
          ...
          <tr>
	          ...
	          <td class="bottom-border" colspan="3">
	          	<select class="span10 " name = "XMFR" fieldname = "CBK.XMFR" defaultMemo="全部" operation="=" kind="dic" src="XMFR">
	            </select>
	          </td>
	           <th class="right-border bottom-border text-right">稳定度</th>
	          <td class="bottom-border">
	          	<select class="span12  " name = "WDD" fieldname = "WDD" defaultMemo="全部" operation="=" kind="dic" src="WDD">
	            </select>
	          </td>
	          <td colspan="6"></td>
	...
	<div class="overFlowX">
		...
		<thead>
			<tr>
				...
				<th fieldname="XMFR" rowspan="2" colindex=8 maxlength="10">项目法人</th>
				...
				<th fieldname="BZ" rowspan="2" colindex="18">备注</th>
			</tr>
			<tr>
