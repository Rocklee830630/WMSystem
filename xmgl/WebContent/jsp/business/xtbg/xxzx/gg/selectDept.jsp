	 ...
	 <div class="row-fluid">
           			...
           			<span class="pull-right">
	  					<button id="btnQd" class="btn" type="button" >确定</button>
           				<button id="deleteQy" class="btn" type="button">清空</button>
      				</span>
    	<form method="post" id="xdxmkForm"  >
      		<table class="B-table">
      		<tr>
      			<td>
      				&nbsp;&nbsp;<input class="span12" type="checkbox" id="qy" name = "QY" lineType="upline"  kind="dic" src="T#VIEW_YW_ORG_DEPT:ROW_ID:DEPT_NAME" fieldname = "QY" >
      			</td>
      		</tr>
