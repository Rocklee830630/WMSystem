...
<app:base/>
 <script type="text/javascript">
	...
	function doInit(){
		...
		setFileData(odd.GC_ZTB_XQ_ID,"",odd.SJBH,odd.YWLX);
			...
			<div class="row-fluid">
				<div class="B-small-from-table-autoConcise">
					...
					<table width="100%" class="table-hover table-activeTd B-table"
						id="DT2" type="single" noPage="true" nopromptmsg="true" pageNum="1000">
						<thead>
							<tr>
								<th name="XH" id="_XH">
									&nbsp;#&nbsp;
					...
					<form method="post" id="demoForm2">
						...
						<table class="B-table" id="DT" width="100%">
							...
							<tr>
								<th class="right-border bottom-border text-right disabledTh" width="8%">
									工作名称
								</th>
								<td class="right-border bottom-border text-right" colspan="3"
									width="17%">
									<input class="span12" placeholder="必填" check-type="required"
							...
							<tr>
								...
								<td width="17%" class="bottom-border" id="tze2">
									<input class="span9" type="number" name="YSE" id="yse"
										style="text-align: right;" placeholder="必填"
										check-type="required" fieldname="YSE">&nbsp;&nbsp;<b>(元)</b>
								</td>
							...
							<tr>
								...
								<td class="right-border bottom-border text-right" colspan="3">
									<textarea fieldname="ZZYJYQ" id="ZZYJYQ" name="ZZYJYQ"
										class="span12" rows="2" maxlength="4000"></textarea>
								</td>
							</tr>
							<tr>
								<th class="right-border bottom-border text-right disabledTh">
							...
							<tr>
								...
								<td class="right-border bottom-border text-right" colspan="3">
									<textarea fieldname="CGMBYQ" id="CGMBYQ" name="CGMBYQ"
										maxlength="4000" class="span12" rows="2"></textarea>
								<th class="right-border bottom-border text-right disabledTh">
									配备人员要求
								</th>
								<td class="right-border bottom-border text-right" colspan="3">
							...
							<tr>
								...
								<td colspan=4 class="bottom-border">
								</td>
							</tr>
							<tr>
								<th width="8%" class="right-border bottom-border text-right disabledTh">
								...
								<td width="92%" colspan=7 class="bottom-border">
									<div>
										...
										<table role="presentation" class="table table-striped">
											<tbody fjlb="0047" class="files showFileTab" id="fileTab"
