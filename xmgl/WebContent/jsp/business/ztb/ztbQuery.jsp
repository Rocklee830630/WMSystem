            ...
            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single" editable="0">
                <thead>
                    <tr>	
							...
							<th fieldname="ZTBMC"  tdalign=""  >&nbsp;招投标名称&nbsp;</th>
							<th fieldname="ZBBH"  tdalign="" >&nbsp;招标编号&nbsp;</th>
							<th fieldname="ZBLX"  tdalign=""  >&nbsp;招标类型&nbsp;</th>
							<th fieldname="ZBFS"  tdalign=""  >&nbsp;招标方式&nbsp;</th>
							<th fieldname="BJXS"  tdalign=""  >&nbsp;报价系数&nbsp;</th>
							<th fieldname="ZZBJ"  tdalign=""  >&nbsp;总中标价&nbsp;</th>
							<th fieldname="DSFJGID"  tdalign=""  >&nbsp;中标单位&nbsp;</th>
						</tr>
					</thead>
					<tbody>
                	</tbody>
