...
/*----slider----*/
.header{
	background: url(/xmgl/images/business/banner.png) #ECF0F1 100% 100%;
...
.banner-info {
	margin:8% auto 0;
	text-align: center;
	font-family:SimYou,Microsoft YaHei;
}
.banner-info h1 {
	text-align: center;
	font-size:6em;
...
/*-----contact-----------*/
div#contact{
	background: url(../images/bg3.png) #ECF0F1 100% 100%;
	background-size:cover;
	-webkit-background-size:cover;
	-o-background-size:cover;
	-moz-background-size:cover;
...
@media(max-width:768px){
	.header {
		min-height: 419px;
		background: url(/xmgl/images/business/banner.png) #ECF0F1 no-repeat;
		background-size: 100%;
	}
	.banner-info img {
		width: 9%;
...
<script type="text/javascript">
	...
	function setPageHeight(){
		$(".header").attr("style","height:"+(getDivStyleHeight())+"px");
	}
	$(function(){
		setPageHeight();
			...
			<div class="banner">
				<div class="container">
					<div class="banner-info">
						...
						<p>
							该页面正在开发，统计规则尚未确定，还无法使用
						</p>
						<a class="slide-btn" href="#" id="goToHomePage">返回首页</a>
					</div>
				</div>
			</div>
		</div>
