				...
				<form method="post" id="queryForm">
					<table class="B-table" width="100%">
						...
						<tr>
							...
							<input class="span12" type="text" name="XMBH" fieldname="t.XMBH" operation="like" id="XMBH" >
							</td>
							...
							<input class="span12" type="text" name="BDMC" fieldname="t.BDMC" operation="like" id="BDMC" >
							</td>
