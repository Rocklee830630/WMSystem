...
<%
	...
	String cjdwid = request.getParameter("id"); 
%>
...
var controllernamecjdw= "${pageContext.request.contextPath }/cjdw/cjdwController.do";
var objRow;
var cjdwid = '<%=cjdwid%>';
...
function queryList(){
	...
	//调用ajax插入
	defaultJson.doQueryJsonList(controllernamecjdw+"?queryXMXXList&cjdwid="+cjdwid,data,DT1);
}
//项目名称自动模糊查询参数
