...
<title>选择参建单位</title>
<%
	String dwlx = request.getParameter("dwlx");//默认单位类型
	String isLxSelect = request.getParameter("isLxSelect");//是否可选择单位类型
...
$(function() {
	...
	$("#btnXz").click(function() {
		$(window).manhuaDialog({"title":"参建单位>新增","type":"text","content":"${pageContext.request.contextPath}/jsp/business/gcb/cjdw/cjdw_add.jsp?dwlx="+dwlx+"&isLxSelect="+isLxSelect,"modal":"4"});
	});
});
//页面默认参数
function init(){
