...
$(function() {
    ...
    $("#btnSave").click(function() {
    	...
    	var dwmc=$("#DWMC").val();
    	var dwlx=$("#DWLX").val();
    	var id =$("#GC_CJDW_ID").val();
    	var action1 = controllername + "?queryByMingChen&dwmc="+dwmc+"&dwlx="+dwlx+"&id="+id;
		$.ajax({
			url : action1,
			async :	false,
	...
	del.click(function()
	{
		...
		$('#ConfirmYesButton').one("click",function(){ 
			defaultJson.doDeleteJson(controllername+"?deleteCJDW",data1,null,"deleteHuiDiao"); 
		});
	});
});
//删除回调
...
function setFormDate(){
	...
	$("#cjdwForm").setFormValues(convertJson.string2json1(rowValue));
}
</script>      
</head>
<body>
     ...
     <form method="post" id="cjdwForm">
      ...
      <input type="hidden" id="GC_CJDW_ID" fieldname="GC_CJDW_ID" name = "GC_CJDW_ID"/>
        <tr>
          ...
          <td class="right-border bottom-border">
          	<input class="span12" id="ZBCS" type="number" style="text-align:right" fieldname="ZBCS" name = "ZBCS" />
          </td>
        </tr>
        <tr>
