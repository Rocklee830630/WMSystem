...
<script type="text/javascript" charset="utf-8">
  ...
  function setPageHeight(){
	...
	$(function() {
		...
		//负责人更改
		var fzzrgb=$("#fzzrgb");
		fzzrgb.click(function() {
			var row_value=$("#DT1").getSelectedRow();
			row_value=convertJson.string2json1(row_value);
			$(window).manhuaDialog({"title":"征收负责人管理>变更","type":"text","content":"${pageContext.request.contextPath}/jsp/business/zsb/zsgl/xxb/fzrbg.jsp","modal":"4"});
		});
...
<app:dialogs/>
    ...
    <div class="B-small-from-table-autoConcise">
      <h4 class="title">任务负责人管理<span class="pull-right">
      				<app:oPerm url="jsp/business/zsb/zsgl/xxb/fzrbg.jsp">
	         		 <button id="fzzrgb" class="btn"  type="button">变更 </button>
	         		 </app:oPerm>
            ...
            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single" printFileName="征收任务管理">
                <thead>
                    <tr>	
							...
							<th fieldname="FZR" rowspan="2" colindex=6 maxlength="15">&nbsp;负责人&nbsp;</th>
