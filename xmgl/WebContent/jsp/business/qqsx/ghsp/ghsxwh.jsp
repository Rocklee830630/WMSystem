      ...
      <!--可以再此处加入hidden域作为过滤条件 -->
        ...
        <tr>
          ...
          <td class="left-border bottom-border" width="10%">
          	<select class="span12" id="FJLX" name = "FJLX" fieldname = "FJLX" operation="=" kind="dic" src="GHSX">
            </select>
          </td>
     ...
     <form method="post" id="SxfjForm"  >
      <table class="B-table" width="100%">
        ...
        <tr>
          ...
          <select class="span12" id="FJLX1" name = "FJLX" fieldname = "FJLX" kind="dic" src="GHSX" >
            </select>
          </td>
          <th width="8%" class="right-border bottom-border text-right">文号名称</th>
          <td width="42%" class="right-border bottom-border"><input class="span12"  type="text" placeholder="必填"  check-type="required" fieldname="WHMC" name = "WHMC" check-type="maxlength" maxlength="200"></td>          
        </tr>
        <tr>
        ...
        <tr>
			<th width="8%" class="right-border bottom-border text-right">附件信息</th>
			   <td colspan="3" class="bottom-border right-border">
					<div>
						<span class="btn btn-fileUpload" id="scfj" onclick="doSelectFile(this);" fjlb="0100">
								<i class="icon-plus"></i>
								<span>添加文件...</span>
						</span>
							<table role="presentation" class="table table-striped">
								<tbody id="scfj1" fjlb="0100" class="files showFileTab" data-toggle="modal-gallery" data-target="#modal-gallery">
						</tbody>
					</table>
				</div>
			</td>
