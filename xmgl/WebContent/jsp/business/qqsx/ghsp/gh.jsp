  ...
  var controllername= "${pageContext.request.contextPath }/qqsx/ghsp/ghspController.do";
	$(function() {
		...
		querybtn.click(function() {
				...
				//调用ajax插入
				defaultJson.doQueryJsonList(controllername+"?queryGhsp",data,DT1);
				});
		savebtn.click(function() {
				...
				//$("#DT1").updateResult(data,DT1,rowindex);
					...
					var data1 = defaultJson.packSaveJson(data);
					//调用ajax插入
					defaultJson.doUpdateJson(controllername + "?updateGhsp", data1,DT1);
					}
				}
				});
		whbtn.click(function(){
			if(qqsxid==null||qqsxid==""){
				...
				parent.$("body").manhuaDialog({"title":"规划审批手续>维护","type":"text","content":"${pageContext.request.contextPath}/jsp/business/qqsx/ghsp/ghsxwh.jsp?id="+aa,"modal":"2"});	
					}		
				});
		update.click(function(){
			if(qqsxid==null||qqsxid==""){
				...
				parent.$("body").manhuaDialog({"title":"规划审批信息>维护","type":"text","content":"${pageContext.request.contextPath}/jsp/business/qqsx/ghsp/ghxxwh.jsp?json="+json,"modal":"2"});	
					}		
				});
	});
  ...
  <div class= "overFlowX">
	<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" >
		<thead>
            ...
            <th colspan="4">&nbsp;&nbsp;进度&nbsp;&nbsp;</th>
            <th rowspan="2" fieldname="CZWT" colindex=7 maxlength="15">&nbsp;&nbsp;存在问题&nbsp;&nbsp;</th>
            <th rowspan="2" fieldname="BBLYY" colindex=8 maxlength="15">&nbsp;&nbsp;不办理手续原因&nbsp;&nbsp;</th>
            <th rowspan="2" fieldname="JBR" colindex=9>&nbsp;&nbsp;经办人&nbsp;&nbsp;</th>
            <th rowspan="2" fieldname="BBLSX" colindex=10>&nbsp;&nbsp;不办理手续&nbsp;&nbsp;</th>
            <th rowspan="2" fieldname="BBLFJ" colindex=11>&nbsp;&nbsp;不办理原因附件&nbsp;&nbsp;</th>
            </tr>
            <tr>
            <th fieldname="JSXZXMYJS" colindex=3 >&nbsp;&nbsp;建设选址项目意见书&nbsp;&nbsp;</th>
            <th fieldname="JSYDGHXKZ" colindex=4 >&nbsp;&nbsp;建设用地规划许可证&nbsp;&nbsp;</th>
            <th fieldname="JSGCGHXKZ" colindex=5 >&nbsp;&nbsp;建设工程规划许可证&nbsp;&nbsp;</th>
            <th fieldname="BJSJ" colindex=6 tdalign="center">&nbsp;&nbsp;办结时间&nbsp;&nbsp;</th>
			</tr>
		</thead>
	<tbody></tbody>
	</table>
