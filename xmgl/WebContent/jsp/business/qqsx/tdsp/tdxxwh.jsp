...
var controllername= "${pageContext.request.contextPath }/qqsx/tdsp/tdspController.do";
	$(document).ready(function(){
		...
		var aa=$(odd).attr("GC_QQSX_TTSP_ID");
	...
	$(function() {
		...
		savebtn.click(function() {
					...
					//调用ajax插入
					defaultJson.doUpdateJson(controllername + "?updateTdsp", data1,null);
					//从resultXML获取修改的数据
...
<div style="height:5px;"></div>
    <div class="B-small-from-table-autoConcise">
      <h4 class="title">土地手续信息<span class="pull-right">
     ...
     <form method="post" id="GhspForm"  >
      <table class="B-table" width="100%">
        ...
        <!-- <TR> -->
			...
			<TD><input type="text" class="span12" kind="text" id="GC_QQSX_TTSP_ID" fieldname="GC_QQSX_TTSP_ID" name="GC_QQSX_TTSP_ID" keep="true"></TD>
        ...
        <tr>
          ...
          <td width="42%" colspan="2" class="right-border bottom-border"><input class="span12"  type="text" readonly fieldname="XMMC" id="XMMC" name = "XMMC" check-type="maxlength" maxlength="200" keep="true"></td>
          <th width="8%" class="right-border bottom-border text-right">办结时间</th>
		  <td width="20%" class="left-border bottom-border" >
        ...
        <tr>
        <th width="8%" class="right-border bottom-border text-right">不办理手续</th>
        <td width="92%" colspan="4" class="right-border bottom-border">
        <input class="span12" type="checkbox" placeholder="" id="BBLSX" name = "BBLSX"  kind="dic" src="TDSPSX" fieldname = "BBLSX" ></td>
        </tr>
        <tr>
