	...
	function setValue(){
	  ...
	  function getDate() {
		var date;
	 	 ...
	 	 if(bjsj=="null"||bjsj==""){
	 		var json_fz='{"TDSPBJSJ":\"'+date+'\","TDSPBJSJ_SV":\"'+date+'\"}';
      ...
      <table class="B-table" width="100%">
        ...
        <tr>
          ...
          <td width="20%" class="bottom-border">
            <input class="span12 date"  type="date" placeholder="必填"  check-type="required" id="TDSPBJSJ" fieldname="TDSPBJSJ" fieldtype="date" name ="TDSPBJSJ" fieldformat="YYYY-MM-DD" /></td>
