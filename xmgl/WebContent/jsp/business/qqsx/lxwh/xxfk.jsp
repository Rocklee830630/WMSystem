  ...
  var sjwybh,jhsjid,bjsj;		
	...
	function setValue(){
	 ...
	 var date;
    	 ...
    	 if(bjsj=="null"||bjsj==""){
    		var json_fz='{"LXKYBJSJ":\"'+date+'\","LXKYBJSJ_SV":\"'+date+'\"}';
      ...
      <table class="B-table" width="100%">
        ...
        <tr>
          ...
          <td width="20%" class="bottom-border">
            <input class="span12 date"  type="date" placeholder="必填"  check-type="required" id="LXKYBJSJ" fieldname="LXKYBJSJ" fieldtype="date" name ="LXKYBJSJ" fieldformat="YYYY-MM-DD" /></td>
