...
<script type="text/javascript" charset="utf-8">
	...
	$(function(){
		...
		$("#printButton").click(function(){
			$(this).hide();
			//window.print();
			var turl = document.getElementById("myframe").src;
	        var newW = window.open("/xmgl/jsp/business/qqsx/qqsxbz/qqsxbzjmbf.jsp");
	        newW.print(); 
			$(this).show();  
		});
	});
...
<div class="container-fluid">
    ...
    <h4 style="background:none; color:#333; border-bottom:#ccc solid 1px;padding-left:10px;">前期手续详情跟踪</h4>
        <div class="container-fluid">
            <div class="row-fluid">
              <div class="span6">
              <h4  align="center" style="background:none; color:#333;width: 560px;">立项可研进展整体状况
...
<iframe id=myframe src="/xmgl/jsp/business/qqsx/qqsxbz/qqsxbzjmbf.jsp"></iframe> 
</body>
</html>