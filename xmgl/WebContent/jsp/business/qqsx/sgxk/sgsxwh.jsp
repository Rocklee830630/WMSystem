...
/*     function dofjlb(){
    	alert("AAAAAAAA");
    	var dd=document.getElementById("BLR").value;
    	alert(dd);
    	var fj=Number(document.getElementById("SXFJ1").value);
    	alert(fj);
    	if(fj==null||fj==""){
    		$("#scfj").attr("fjlb",fj);
			$("#scfj1").attr("fjlb",fj);
 ...
 <div class="row-fluid">
      ...
      <!--可以再此处加入hidden域作为过滤条件 -->
        ...
        <tr>
          ...
          <td class="left-border bottom-border" width="10%">
          	<select class="span12" id="FJLX" name = "FJLX" fieldname = "FJLX" operation="=" kind="dic" src="SGXKSX">
            </select>
          </td>
	...
	<div class="B-small-from-table-autoConcise">
      ...
      <span class="pull-right">
          ...
          <button id="clear" name="clean" class="btn"  type="button">清空</button>
          </span></h4>
     <form method="post" id="SxfjForm"  >
      <table class="B-table" width="100%">
        ...
        <tr>
          ...
          <select class="span12" id="FJLX1" name = "FJLX" fieldname = "FJLX" kind="dic" src="SGXKSX" >
            </select>
          </td>
