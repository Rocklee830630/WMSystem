      ...
      <table class="B-table" width="100%">
        ...
        <tr>
          ...
          <td width="20%" class="bottom-border">
            <input class="span12 date"  type="date" placeholder="必填"  check-type="required" id="SGXKBJSJ" fieldname="SGXKBJSJ" fieldtype="date" name ="SGXKBJSJ" fieldformat="YYYY-MM-DD" /></td>
