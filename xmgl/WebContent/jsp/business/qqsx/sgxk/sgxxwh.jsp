...
var controllername= "${pageContext.request.contextPath }/qqsx/sgxk/sgxkController.do";
	$(document).ready(function(){
		...
		var aa=$(odd).attr("GC_QQSX_SGXK_ID");
	...
	$(function() {
		...
		savebtn.click(function() {
					...
					//调用ajax插入
					defaultJson.doUpdateJson(controllername + "?updateSgxk", data1,null);
					//从resultXML获取修改的数据
...
<p></p>
 <div class="row-fluid">
 <div class="B-small-from-table-auto" hidden="true">
  <div class= "overFlowX">
     ...
     <form method="post" id="GhspForm"  >
      <table class="B-table">
        ...
        <!-- <TR> -->
			...
			<TD><input type="text" class="span12" kind="text" id="GC_QQSX_SGXK_ID" fieldname="GC_QQSX_SGXK_ID" name="GC_QQSX_SGXK_ID" keep="true"></TD>
        ...
        <tr>
          ...
          <td width="42%" colspan="3" class="right-border bottom-border"><input class="span12"  type="text" readonly fieldname="XMMC" id="XMMC" name = "XMMC" check-type="maxlength" maxlength="200" keep="true"></td>
        ...
        <input class="span12" type="checkbox" placeholder="" id="BBLSX" name = "BBLSX"  kind="dic" src="SGXKSX" fieldname = "BBLSX" ></td>
        </tr>
        <tr>
          <th width="8%" class="right-border bottom-border text-right">不办理原因</th>
          <td width="42%" colspan="5" class="right-border bottom-border">
