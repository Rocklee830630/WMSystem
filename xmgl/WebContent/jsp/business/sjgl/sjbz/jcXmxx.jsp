...
function queryList(){
	...
	//调用ajax插入
	defaultJson.doQueryJsonList(controllername+"?jcjcValue&index="+index+"&name="+name+"&nd="+nd,data,DT1);
}
	...
	<table class="table-hover table-activeTd B-table" id="DT1"  width="100%" editable="0" type="single">
		<thead>
			<tr>
				...
				<th fieldname="BDMC" maxlength="15" CustomFunction="showBdmc">&nbsp;标段名称&nbsp;</th>
				<th fieldname="BGLB" tdalign="center" >&nbsp;检测类别&nbsp;</th>
				...
				<th fieldname="BZ" maxlength="20" >&nbsp;信息说明&nbsp;</th>
			</tr>
		</thead>
		<tbody>
           </tbody>
