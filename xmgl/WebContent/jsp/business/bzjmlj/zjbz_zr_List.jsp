...
<html>
	<head>
		...
		<%	String nd = request.getParameter("nd");
			...
			String tiaojian = request.getParameter("flag");
		%>
		<style>
		.myCellSpan{
	...
	<script src="${pageContext.request.contextPath }/js/common/bootstrap.autocomplete.js"></script>
		<script type="text/javascript" charset="utf-8">
			...
			function doSearch(){
				...
				defaultJson.doQueryJsonList(controllername+"?querySjglList"+condTiaojian+condNd+condProKey,data,DT1,null,false);
			}
			//项目名称自动模糊查询参数
						...
						<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" printFileName="项目详细列表">
							<thead>
					           <tr>
									...
									<th fieldname="XMMC" maxlength="15" rowMerge="true" rowspan=2 colindex=2>
										&nbsp;项目名称&nbsp;
									</th>
									<th fieldname="BDMC" maxlength="15" rowspan=2 colindex=3 CustomFunction="doBdmc">
										&nbsp;标段名称&nbsp;
									</th>
									<th fieldname="XMBDDZ" maxlength="15" rowspan=2 colindex=4>
										&nbsp;项目地址&nbsp;
									</th>
									...
									<th fieldname="GYS" rowspan=2 colindex=8 tdalign="right">
										&nbsp;概算&nbsp;
									</th>
									<th fieldname="ZXGS" maxlength="15" rowspan=2 colindex=9>
										&nbsp;咨询公司&nbsp;
									</th>
									<th colspan=2>
										&nbsp;提报价&nbsp;
								...
								<tr>
									<th fieldname="SBCSZ" tdalign="right" colindex=10>金额</th>
									<th fieldname="JGBCSRQ" tdalign="right" colindex=11>日期</th>
									<th fieldname="CSSDZ" tdalign="right" colindex=12>金额</th>
									<th fieldname="CZSWRQ" tdalign="right" colindex=13>日期</th>
								</tr>
							</thead>
							<tbody>
							</tbody>
