	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function doSearch(){
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?queryLybzjList"+condNd+condProKey,data,DT1,null,false);
			}
					...
					<form method="post" id="queryForm">
						<table class="B-table" width="100%">
						   <tr>
						      ...
						      <th width="5%" class="right-border bottom-border text-right">缴纳方式</th>
					          <td class="right-border bottom-border" width="10%">
