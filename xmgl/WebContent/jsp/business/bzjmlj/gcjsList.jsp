...
<script type="text/javascript" charset="utf-8">
	...
	function doSearch(){
		...
		var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
		defaultJson.doQueryJsonList(controllername+"?queryJsljList"+condTiaojian+condNd+condProKey+condLie,data,DT1,null,false);
	}
</script>     
</head>
	<body>
					...
					<table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single" printFileName="项目详细列表">
						<thead>
							<tr>
								...
								<th fieldname="XMMC" maxlength="15" rowspan=2 colindex=2>
									&nbsp;项目名称&nbsp;
								</th>
