	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function doSearch(){
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?querySjJJGglList"+condTiaojian+condNd+condProKey+condSGJL,data,DT1,null,false);
			}
						...
						<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" printFileName="项目详细列表">
							<thead>
				          	<tr>
								...
								<th fieldname="JU_SFBZJZ" colindex=7 maxlength="15">&nbsp;是否报质监站&nbsp;</th>
								<th fieldname="JU_JBYSTJ" colindex=8 maxlength="10"  >&nbsp;是否具备验收条件&nbsp;</th>
								<th fieldname="JU_SFZZYS" colindex=9 >&nbsp;是否组织竣工验收&nbsp;</th>
								<th fieldname="JU_YSQK" colindex=10 maxlength="10" >&nbsp;验收情况&nbsp;</th>
								<th fieldname="JGYSRQ" colindex=11 tdalign="center"  >&nbsp;交工时间&nbsp;</th>
								<th fieldname="JGYSSJ" colindex=12 tdalign="center"  >&nbsp;竣工时间&nbsp;</th>
							 </tr>
							</thead>
							<tbody>
							</tbody>
