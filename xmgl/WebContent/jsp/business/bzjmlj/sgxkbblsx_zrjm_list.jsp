	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function doSearchQqSg(){
				...
				defaultJson.doQueryJsonList(controllername+"?queryListQqsg"+condNd +condproKey +condSgflag,data,DT1,null,false);
			}
					...
					<form method="post" id="queryForm">
						<table class="B-table" width="100%">
							<tr>
								...
								<td width="10%" class="right-border bottom-border">
									<input class="span12" type="text" placeholder="" id="BDMC" name="BDMC" fieldname="BDMC" operation="like" logic="and"></td>
