						...
						<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" printFileName="项目详细列表">
							<thead>
				          	<tr>
								...
								<th fieldname="WCSJ_SGT_SSB" colindex=10 maxlength="10" >&nbsp;施工图（送审版）&nbsp;</th>
								<th fieldname="WCSJ_SGT_ZSB" colindex=11 tdalign="center"  >&nbsp;施工图（正式）&nbsp;</th>
								<th fieldname="CQT_SJ" colindex=12 tdalign="center"  >&nbsp;拆迁图&nbsp;</th>
							 </tr>
							</thead>
							<tbody>
							</tbody>
