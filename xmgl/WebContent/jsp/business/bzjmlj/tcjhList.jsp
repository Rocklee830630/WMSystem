	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function setPageHeight(){
				...
				var height = getHeight-pageTopHeight-pageQuery-pageTitle-getTableTh(2)-pageNumHeight;
			...
			function doSearchQq(){
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?queryList_Qq"+condNd+condSxbh+condSxmc+condBllx+condSgflag+condSGJL,data,DT1,null,false);
			}
			function doSearchQq_sg(){
				var condSgflag = "";
				if(sgflag!=null&&sgflag!=""){
					condSgflag = "&sgflag="+sgflag;
				}
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?queryList_Qq"+condNd+condSgflag+condSGJL,data,DT1,null,false);
			}
			function doSearch(){
				var condProKey = "";
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?queryList"+condTiaojian+condNd+condProKey+condSGJL,data,DT1,null,false);
			}
						...
						<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" printFileName="项目详细列表">
							<thead>
				          	<tr>
								...
								<th fieldname="XMGLGS"  rowspan="2" colindex=8 maxlength="10"  >&nbsp;项目管理公司&nbsp;</th>
								<th fieldname="ISBT"  rowspan="2" colindex=9 tdalign="center">&nbsp;BT&nbsp;</th>
								<th fieldname="JSNR"  rowspan="2" colindex=10 maxlength="10" >&nbsp;建设内容及规模&nbsp;</th>
								<th fieldname="SGDW"  rowspan="2" colindex=11 tdalign="center"  >&nbsp;施工单位&nbsp;</th>
								<th fieldname="JLDW"  rowspan="2" colindex=12 tdalign="center"  >&nbsp;监理单位&nbsp;</th>
								<th fieldname="KGSJ_SJ"  rowspan="2" colindex=13 tdalign="center"  >&nbsp;开工日期&nbsp;</th>
								<th fieldname="WGSJ_SJ"  rowspan="2" colindex=14 maxlength="10" tdalign="center">&nbsp;完工日期&nbsp;</th>
