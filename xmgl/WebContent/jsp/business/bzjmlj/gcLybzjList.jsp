	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
			...
			function doSearch(){
				...
				var data = combineQuery.getQueryCombineData(queryForm,frmPost,DT1);
				defaultJson.doQueryJsonList(controllername+"?queryList_gc_lybzj"+condNd+condProKey,data,DT1,null,false);
			}
						   ...
						   <tr>
					          ...
					          <td class="right-border bottom-border" width="10%">
					          	<input class="span12" type="text" placeholder="" name="HTBM"
									fieldname="HT.HTBM" operation="like" id="HTBM" />
							  </td>   
							  <th width="5%" class="right-border bottom-border text-right">合同名称</th>
					          <td class="right-border bottom-border" width="10%">
					          	<input class="span12" type="text" placeholder="" name="HTMC"
									fieldname="HT.HTMC" operation="like" id="HTMC" />
							  </td>
						      <th width="5%" class="right-border bottom-border text-right">交纳方式</th>
					          <td class="right-border bottom-border" width="10%">
					            <select class="span12" id="JNFS" name = "JNFS" fieldname="JNFS"  defaultMemo="全部" operation="="  kind="dic" src="JNFS">
					             </select>
							  </td>
						...
						<table class="table-hover table-activeTd B-table" id="DT1" width="100%" type="single" printFileName="项目详细列表">
							<thead>
				              <tr>
								...
								<th fieldname="JGYSSJ" colindex=10 tdalign="center">&nbsp;竣工验收日期&nbsp;</th>
								<th fieldname="TBRQ" colindex=10 tdalign="center">&nbsp;结算提报日期&nbsp;</th>
								<th fieldname="HTMC" colindex=13 maxlength="15">&nbsp;合同名称&nbsp;</th>
								<th fieldname="HTBM" colindex=12 >&nbsp;合同编码&nbsp;</th>
								<th fieldname="JNDW" colindex=11 maxlength="15">&nbsp;交纳单位&nbsp;</th>
								<th fieldname="JNFS" colindex=8>&nbsp;交纳方式&nbsp;</th>			
								<th fieldname="JE" colindex=7 tdalign="right">&nbsp;金额&nbsp;</th>
								<th fieldname="JNRQ" colindex=6 tdalign="center">&nbsp;交纳日期&nbsp;</th>
