	...
	<head>
		...
		<script type="text/javascript" charset="utf-8">
				...
				$("#btnSave").click(function(){
					if($("#insertForm").validationButton()){
						var index =	$("#tabList").getSelectedRowIndex();
 						...
 						if(index!=-1){
 							defaultJson.doUpdateJson(controllername + "?updateWtjj", data1,tabList,null);
 						}else{
 							defaultJson.doInsertJson(controllername + "?insertWtjj", data1,tabList,null);
			...
			function doInit(){
				...
				defaultJson.doQueryJsonList(controllername+"?queryWtjj",data,tabList,null,true);
						...
						<form method="post" action="" id="insertForm">
							<table class="B-table" width="100%">
								...
								<tr style="display: none;">
									...
									<td width="42%" class="right-border bottom-border">
										<input class="span12" type="text" name="GC_PQ_WT_ID"
											fieldname="GC_PQ_WT_ID">
									</td>
								</tr>
								<tr>
									<th width="8%" class="right-border bottom-border">
									...
									<td width="42%" class="right-border bottom-border">
										<input class="span5" type="date" name="JZRQ" fieldname="JZRQ"
											placeholder="必填" check-type="required">
									</td>
									<th width="8%" class="right-border bottom-border">
