...
<div class="container-fluid">
 ...
 <div class="B-small-from-table-autoConcise">
  <h4 class="title">项目信息
  <font id="XSXMMC" class="title" style="color:red;">&nbsp;</font>
 ...
 <form method="post" id="demoForm">
 	<table class="B-table">
			  ...
			  <tr>
				<th width="8%" class="right-border bottom-border text-right">交工开始日期</th>
				<td width="25%" class="right-border bottom-border">
					<input class="span12 date" name ="JA_KSRQ" id="JA_KSRQ" fieldname="JA_KSRQ" type="date"/>
				</td>
				<th width="8%" class="right-border bottom-border text-right">交工验收日期</th>
				<td width="25%" class="right-border bottom-border">
					<input class="span12 date" name ="JGYSRQ" id="JGYSRQ" fieldname="JGYSRQ" type="date"/>
				</td>
			   ...
			   <tr>
					...
					<td width="92%" colspan="5"  class="bottom-border">
						<textarea class="span12" rows="4" id="JIAOGJSDW" check-type="maxlength" maxlength="500" fieldname="JIAOGJSDW" name="JIAOGJSDW"></textarea>
					</td>
			   </tr>
			   <tr>
				   	<th width="8%" class="right-border bottom-border text-right">接收人</th>
					<td width="92%" colspan="5" class="bottom-border">
						<textarea class="span12" rows="4" id="JIAOGJSR" check-type="maxlength" maxlength="500" fieldname="JIAOGJSR" name="JIAOGJSR"></textarea>
					</td>
			   </tr>
			<tr>															
