...
$(function() {
	...
	$("#btnInsert").click(function() {
		$(window).manhuaDialog({"title":"提请款明细>新增","type":"text","content":"${pageContext.request.contextPath }/jsp/business/zjgl/tqkmx-add.jsp?type=insert","modal":"1"});
	});
	//按钮绑定事件(修改)
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"提请款明细>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/zjgl/tqkmx-add.jsp?type=update","modal":"1"});
	});
	//按钮绑定事件（导出EXCEL）
...
function rowView(index){
	...
	$("#resultXML").val($("#DT1").getSelectedRow());
	$(window).manhuaDialog({"title":"提请款明细>详细信息","type":"text","content":"${pageContext.request.contextPath }/jsp/business/zjgl/tqkmx-add.jsp?type=detail","modal":"1"});
}
</script>
</head>
<body>
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="HTID" colindex=1 tdalign="center" maxlength="30" >&nbsp;合同编号&nbsp;</th>
							<th fieldname="TQKID" colindex=2 tdalign="center" maxlength="30" >&nbsp;提请款编号&nbsp;</th>
							<th fieldname="DWID" colindex=3 tdalign="center" maxlength="30" >&nbsp;&nbsp;</th>
							<th fieldname="DWMC" colindex=4 tdalign="center" maxlength="30" >&nbsp;单位全称&nbsp;</th>
							<th fieldname="XMMCNR" colindex=5 tdalign="center" maxlength="30" >&nbsp;项目名称内容&nbsp;</th>
							...
							<th fieldname="YWLX" colindex=15 tdalign="center" >&nbsp;业务类型&nbsp;</th>
							<th fieldname="SJBH" colindex=16 tdalign="center" maxlength="30" >&nbsp;事件编号&nbsp;</th>
							<th fieldname="SJMJ" colindex=17 tdalign="center" maxlength="30" >&nbsp;数据密级&nbsp;</th>
							<th fieldname="SFYX" colindex=18 tdalign="center" >&nbsp;是否有效&nbsp;</th>
							<th fieldname="BZ" colindex=19 tdalign="center" maxlength="30" >&nbsp;备注&nbsp;</th>
							<th fieldname="LRR" colindex=20 tdalign="center" >&nbsp;录入人&nbsp;</th>
							<th fieldname="LRSJ" colindex=21 tdalign="center" >&nbsp;录入时间&nbsp;</th>
							<th fieldname="LRBM" colindex=22 tdalign="center" >&nbsp;录入部门&nbsp;</th>
							<th fieldname="LRBMMC" colindex=23 tdalign="center" maxlength="30" >&nbsp;录入部门名称&nbsp;</th>
							<th fieldname="GXR" colindex=24 tdalign="center" >&nbsp;更新人&nbsp;</th>
							<th fieldname="GXSJ" colindex=25 tdalign="center" >&nbsp;更新时间&nbsp;</th>
							<th fieldname="GXBM" colindex=26 tdalign="center" >&nbsp;更新部门&nbsp;</th>
							<th fieldname="GXBMMC" colindex=27 tdalign="center" maxlength="30" >&nbsp;更新部门名称&nbsp;</th>
							<th fieldname="SORTNO" colindex=28 tdalign="center" >&nbsp;排序号&nbsp;</th>
	                	</tr>
	                </thead>
	              	<tbody></tbody>
	           </table>
