...
$(function() {
	...
	$("#btnInsert").click(function() {
		$(window).manhuaDialog({"title":"提请款部门明细>新增","type":"text","content":"${pageContext.request.contextPath }/jsp/business/zjgl/tqkbmmx-add.jsp?type=insert","modal":"1"});
	});
	//按钮绑定事件(修改)
	$("#btnUpdate").click(function() {
		...
		$(window).manhuaDialog({"title":"提请款部门明细>修改","type":"text","content":"${pageContext.request.contextPath }/jsp/business/zjgl/tqkbmmx-add.jsp?type=update","modal":"1"});
	});
	//按钮绑定事件（导出EXCEL）
	            ...
	            <table width="100%" class="table-hover table-activeTd B-table" id="DT1" type="single"  pageNum="18">
	                <thead>
	                	<tr>
							...
							<th fieldname="DWID" colindex=3 tdalign="center" maxlength="30" >&nbsp;单位ID&nbsp;</th>
