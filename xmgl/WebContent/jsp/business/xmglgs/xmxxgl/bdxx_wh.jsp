    ...
    <div class="B-small-from-table-autoConcise">
     ...
     <form method="post" id="bdxxForm"  >
      <table class="B-table" width="100%" id="bdxxList">
        ...
        <tr>
        	<th width="5%" class="right-border bottom-border disabledTh">标段编号</th>
			<td class="right-border bottom-border" width="10%"> 
				<input class="span12"  type="text"  fieldname="BDBH" id="BDBH" name = "BDBH" readonly />
			</td>
			<th width="5%" class="right-border bottom-border disabledTh">标段名称</th>
			<td class="right-border bottom-border" colspan="3"> 
				<input class="span12"  type="text"  fieldname="BDMC" id="BDMC" name = "BDMC" readonly />
			</td>
        </tr>
      </table>
      <h5 id="sjdw" class="black">设计单位</h5>
		<table id="T_sjdw" class="B-table" width="100%">
			<tr>
	          <th width="10%" class="right-border bottom-border disabledTh">单位名称 </th>
	          <td class="right-border bottom-border" colspan="3">
	          	<input class="span12"  type="text" fieldname="SJDW" name = "SJDW" readonly />
	          </td>
        	</tr>
        	<tr>
        	  <th width="10%" class="right-border bottom-border">设计负责人</th>
	          <td  class="bottom-border" width="15%">
	          	<input class="span12" type="text" name = "SJDWFZR" maxlength="100" fieldname= "SJDWFZR" />
	          	</td>
	          <th width="10%" class="right-border bottom-border">联系电话</th>
	          <td class="bottom-border">
	          	<input class="span12" type="text" name = "SJDWFZRLXFS" maxlength="100" fieldname= "SJDWFZRLXFS"  style="width:40%"/>
	          </td>
        	</tr>
		</table>
		...
		<table id="T_sgdw" class="B-table" width="100%">
        	...
        	<tr>
        	  <th width="10%" class="right-border bottom-border">项目经理</th>
	          <td class="bottom-border">
	          ...
	          <th width="10%" class="right-border bottom-border">技术负责人</th>
	          <td class="bottom-border">
		...
		<table id="T_jldw" class="B-table" width="100%">
        	...
        	<tr>
        		<th width="10%" class="right-border bottom-border">总监</th>
	          <td  class="bottom-border">
	          	<input class="span12" type="text" name = "JLDWZJ" maxlength="100" fieldname= "JLDWZJ" />
	          	</td>
	          <th width="5%" class="right-border bottom-border">联系电话</th>
	          <td class="bottom-border">
	          	<input class="span12" type="text" name = "JLDWZJLXDH" maxlength="100" fieldname= "JLDWZJLXDH" />
	          </td>
	          <th width="5%" class="right-border bottom-border">总监代表</th>
	          <td  class="bottom-border">
	          ...
	          <th width="5%" class="right-border bottom-border">安全监理</th>
	          <td  class="bottom-border">
...
<div align="center">
	<FORM name="frmPost" method="post" style="display:none" target="_blank">
 	<!--系统保留定义区域-->
       ...
       <input type="hidden" name="txtFilter"  order="DESC" fieldname = "bdbh"	id = "txtFilter">
