            ...
            createProgressBar: function (days, id, cls, desc, label, dataObj,nullType,fromDate,toDate) {
                ...
                if(days==1){//计划日期等于实际日期
                	 if(nullType==""||nullType==null){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/xmgl/gantt/img/gtStart.png"></image><image src="/xmgl/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="from"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/xmgl/gantt/img/gtStart-h.png"></image><image src="/xmgl/gantt/img/gtEnd.png"></image></div></div></div>');
                	 }else if(nullType=="all"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/xmgl/gantt/img/gtStart-h.png"></image><image src="/xmgl/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }else if(nullType=="to"){
                	   bar = $('<div class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="gtStartX2"><image src="/xmgl/gantt/img/gtStart.png"></image><image src="/xmgl/gantt/img/gtEnd-h.png"></image></div></div></div>'); 
                	 }
                }else{
                	if(fromlessto == false){
                		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtEnd.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtStart-h.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+fromDate+'</div><div class="dateEnd">'+toDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtStart.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtEnd-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                		
                 	}else{
                 		if(nullType==""||nullType==null){
                       		bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="from"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtEnd.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="all"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtStart-h.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }else if(nullType=="to"){
                        	bar = $('<div '+title_html+' class="bar" ' + barId + '><div class="con"><div class="dateStart">'+toDate+'</div><div class="dateEnd">'+fromDate+'</div><div class="gtStart"><img src="/xmgl/gantt/img/gtEnd-h.png"></div><div class="gtEnd"><img src="/xmgl/gantt/img/gtStart.png"></div><div class="fn-label">' + label + '</div></div></div>')
                     	 }
                	}
                            ...
                            switch (settings.scale) {
                                ...
                                case "weeks":
                                   ...
                                   //     dtTo.setDate(dtTo.getDate() + 4);
                                    ...
                                    var a = dtFrom.valueOf();
                                    a = a+ 24 * 60 * 60 * 1000;
                                    var next_fromDate = new Date(a);
                                    var fromview = (next_fromDate.getMonth()+1)+"."+(next_fromDate.getDate());
                                    
                                    a = dtTo.valueOf();
                                    a = a+ 24 * 60 * 60 * 1000;
                                    var next_toDate = new Date(a);
                                    
                                    var toview = (next_toDate.getMonth()+1)+"."+(next_toDate.getDate());
